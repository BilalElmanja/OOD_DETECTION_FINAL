...
class BenchmarkTorch:
    ...
    DETECTORS_CONFIG = {
        "CRAFT_NMF_10_10_0.5": {
            ...
            "kwargs": {
                "cifar10": dict( n_components=10, n_important_concepts=10, percentage_images_concept=0.5,  model=load_pretrained_weights_32()),
        ...
        "CRAFT_NMF_14_10_0.5": {
            "class": CRAFT_CONCEPTS,
            "kwargs": {
                "cifar10": dict( n_components=14, n_important_concepts=10, percentage_images_concept=0.5, model=load_pretrained_weights_32()),
        ...
        "CRAFT_NMF_18_10_0.5": {
            "class": CRAFT_CONCEPTS,
            "kwargs": {
                "cifar10": dict( n_components=18, n_important_concepts=10, percentage_images_concept=0.5, model=load_pretrained_weights_32()),
        ...
        "CRAFT_NMF_22_10_0.5": {
            "class": CRAFT_CONCEPTS,
            "kwargs": {
                "cifar10": dict( n_components=22, n_important_concepts=10, percentage_images_concept=0.5, n_designs=8 , model=load_pretrained_weights_32()),
        ...
        "CRAFT_NMF_26_10_0.5": {
            "class": CRAFT_CONCEPTS,
            "kwargs": {
                "cifar10": dict( n_components=26, n_important_concepts=10, percentage_images_concept=0.5, n_designs=16 , model=load_pretrained_weights_32()),
        ...
        "CRAFT_NMF_30_10_0.5": {
            "class": CRAFT_CONCEPTS,
            "kwargs": {
                "cifar10": dict( n_components=30, n_important_concepts=10, percentage_images_concept=0.5, n_designs=32 , model=load_pretrained_weights_32()),
        ...
        "CRAFT_NMF_34_10_0.5": {
            "class": CRAFT_CONCEPTS,
            "kwargs": {
                "cifar10": dict( n_components=34, n_important_concepts=10, percentage_images_concept=0.5, n_designs=32 , model=load_pretrained_weights_32()),
                "cifar100": dict( n_components=16, n_designs=32, model=load_pretrained_weights_32()),
            },
            "fit_kwargs": {
                "cifar10": dict(feature_layers_id=[-2]),
        ...
        "CRAFT_NMF_38_10_0.5": {
            "class": CRAFT_CONCEPTS,
            "kwargs": {
                "cifar10": dict( n_components=38, n_important_concepts=10, percentage_images_concept=0.5, n_designs=32 , model=load_pretrained_weights_32()),
                "cifar100": dict( n_components=16, n_designs=32, model=load_pretrained_weights_32()),
            },
            "fit_kwargs": {
                "cifar10": dict(feature_layers_id=[-2]),
...
if __name__ == "__main__":
    dir_path = os.path.expanduser("~/") + "./results/cifar10_craft_tuning_n_important_concepts"
    os.makedirs(dir_path, exist_ok=True)
