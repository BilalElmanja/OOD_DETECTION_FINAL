...
from methods import  K_Means, PCA_KNN, NMF_KNN, PCA_MAHALANOBIS, NMF_MAHALANOBIS, PCA_unique_class_KNN, PCA_Unique_Class_Mahalanobis, NMF_Unique_Classes_KNN, NMF_Unique_Class_Mahalanobis, CRAFT_NMF, NMF_NORM, PCA_NORM
...
if __name__ == "__main__":
    dir_path = os.path.expanduser("~/") + "./results/cifar100_layer_2_nmf_all_methods"
    os.makedirs(dir_path, exist_ok=True)
