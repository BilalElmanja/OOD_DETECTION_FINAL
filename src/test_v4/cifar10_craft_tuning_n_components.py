...
class BenchmarkTorch:
    ...
    DETECTORS_CONFIG = {
        "CRAFT_NMF_16_2_0.5": {
            ...
            "kwargs": {
                "cifar10": dict( n_components=16, n_important_concepts=2, percentage_images_concept=0.5,  model=load_pretrained_weights_32()),
        ...
        "CRAFT_NMF_16_4_0.5": {
            "class": CRAFT_CONCEPTS,
            "kwargs": {
                "cifar10": dict( n_components=16, n_important_concepts=4, percentage_images_concept=0.5, model=load_pretrained_weights_32()),
        ...
        "CRAFT_NMF_16_6_0.5": {
            "class": CRAFT_CONCEPTS,
            "kwargs": {
                "cifar10": dict( n_components=16, n_important_concepts=6, percentage_images_concept=0.5, model=load_pretrained_weights_32()),
        ...
        "CRAFT_NMF_16_8_0.5": {
            "class": CRAFT_CONCEPTS,
            "kwargs": {
                "cifar10": dict( n_components=16, n_important_concepts=8, percentage_images_concept=0.5, n_designs=8 , model=load_pretrained_weights_32()),
        ...
        "CRAFT_NMF_16_12_0.5": {
            "class": CRAFT_CONCEPTS,
            "kwargs": {
                "cifar10": dict( n_components=16, n_important_concepts=12, percentage_images_concept=0.5, n_designs=32 , model=load_pretrained_weights_32()),
        ...
        "CRAFT_NMF_16_14_0.5": {
            "class": CRAFT_CONCEPTS,
            "kwargs": {
                "cifar10": dict( n_components=16, n_important_concepts=14, percentage_images_concept=0.5, n_designs=32 , model=load_pretrained_weights_32()),
                "cifar100": dict( n_components=16, n_designs=32, model=load_pretrained_weights_32()),
            },
            "fit_kwargs": {
                "cifar10": dict(feature_layers_id=[-2]),
        ...
        "CRAFT_NMF_16_16_0.5": {
            "class": CRAFT_CONCEPTS,
            "kwargs": {
                "cifar10": dict( n_components=16, n_important_concepts=16, percentage_images_concept=0.5, n_designs=32 , model=load_pretrained_weights_32()),
                "cifar100": dict( n_components=16, n_designs=32, model=load_pretrained_weights_32()),
            },
            "fit_kwargs": {
                "cifar10": dict(feature_layers_id=[-2]),
...
if __name__ == "__main__":
    dir_path = os.path.expanduser("~/") + "./results/cifar10_craft_tuning_n_components"
    os.makedirs(dir_path, exist_ok=True)
