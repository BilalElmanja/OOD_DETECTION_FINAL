...
class BenchmarkTorch:
    ...
    DETECTORS_CONFIG = {
        ...
        #     "class": PCA_KNN,
        #     "kwargs": {
        #         "cifar10": dict( n_components=10),
        #         "cifar100":dict( n_components=10),
        #     },
        #     "fit_kwargs": {
        #         "cifar10": dict(feature_layers_id=[-2]),
        #         "cifar100": dict(feature_layers_id=[-2]),
        ...
        #     "kwargs": {
        #         "cifar10": dict( n_components=10, model=load_pretrained_weights_32()),
        #         "cifar100": dict( n_components=10),
        #     },
        #     "fit_kwargs": {
        #         "cifar10": dict(feature_layers_id=[-2]),
        ...
        #     "class": CRAFT_CONCEPTS,
        #     "kwargs": {
        #         "cifar10": dict( n_components=16, model=load_pretrained_weights_32()),
        #         "cifar100": dict( n_components=16),
        #     },
        #     "fit_kwargs": {
        #         "cifar10": dict(feature_layers_id=[-2]),
        ...
        #     "class": CRAFT_CONCEPTS,
        #     "kwargs": {
        #         "cifar10": dict( n_components=32, model=load_pretrained_weights_32()),
        ...
        #     "class": CRAFT_CONCEPTS,
        #     "kwargs": {
        #         "cifar10": dict( n_components=16, n_designs=8 , model=load_pretrained_weights_32()),
        ...
        "CRAFT_CONCEPTS": {
            "class": CRAFT_CONCEPTS,
            "kwargs": {
                "cifar10": dict( n_components=12, n_important_concepts=10, percentage_images_concept=0.8, model=load_pretrained_weights_32()),
                "cifar100": dict( n_components=12, n_important_concepts=10, percentage_images_concept=0.8, model=load_pretrained_weights_32(dataset='CIFAR-100', model_version='s0', num_classes=100)),
            },
            "fit_kwargs": {
                "cifar10": dict(feature_layers_id=[-2]),
                "cifar100": dict(feature_layers_id=[-2]),
        ...
        #     "class": CRAFT_CONCEPTS,
        #     "kwargs": {
        #         "cifar10": dict( n_components=16, n_designs=32 , model=load_pretrained_weights_32()),
...
if __name__ == "__main__":
    dir_path = os.path.expanduser("~/") + "./results/rapport_pfe_benchmark_results_cifar_1000"
    os.makedirs(dir_path, exist_ok=True)
