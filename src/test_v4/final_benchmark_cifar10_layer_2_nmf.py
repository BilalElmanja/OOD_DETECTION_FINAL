...
class BenchmarkTorch:
    ...
    DETECTORS_CONFIG = {
        ...
        "NMF_KNN_64": {
            "class": NMF_KNN,
            "kwargs": {
                "cifar10": dict( n_components=64),
                "cifar100":dict( n_components=64),
            },
            "fit_kwargs": {
                "cifar10": dict(feature_layers_id=[-2]),
                "cifar100": dict(feature_layers_id=[-2]),
        ...
        "NMF_KNN_128": {
            "class": NMF_KNN,
            "kwargs": {
                "cifar10": dict( n_components=128),
                "cifar100":dict( n_components=128),
            },
            "fit_kwargs": {
                "cifar10": dict(feature_layers_id=[-2]),
                "cifar100": dict(feature_layers_id=[-2]),
        ...
        "NMF_KNN_256": {
            "class": NMF_KNN,
            "kwargs": {
                "cifar10": dict( n_components=256),
                "cifar100":dict( n_components=256),
            },
            "fit_kwargs": {
                "cifar10": dict(feature_layers_id=[-2]),
                "cifar100": dict(feature_layers_id=[-2]),
...
if __name__ == "__main__":
    dir_path = os.path.expanduser("~/") + "./results/cifar10_layer_2_NMF"
    os.makedirs(dir_path, exist_ok=True)
