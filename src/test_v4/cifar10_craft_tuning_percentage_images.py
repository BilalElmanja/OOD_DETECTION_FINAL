...
import sys
sys.path.append("../")
from methods_v2 import  CRAFT_CONCEPTS
...
class BenchmarkTorch:
    ...
    DETECTORS_CONFIG = {
        "CRAFT_NMF_16_10_0.1": {
            "class": CRAFT_CONCEPTS,
            "kwargs": {
                "cifar10": dict( n_components=16, n_important_concepts=10, percentage_images_concept=0.1,  model=load_pretrained_weights_32()),
                "cifar100": dict( n_components=8),
            },
            "fit_kwargs": {
        ...
        "CRAFT_NMF_16_10_0.2": {
            "class": CRAFT_CONCEPTS,
            "kwargs": {
                "cifar10": dict( n_components=16, n_important_concepts=10, percentage_images_concept=0.2, model=load_pretrained_weights_32()),
        ...
        "CRAFT_NMF_16_10_0.3": {
            "class": CRAFT_CONCEPTS,
            "kwargs": {
                "cifar10": dict( n_components=16, n_important_concepts=10, percentage_images_concept=0.3, model=load_pretrained_weights_32()),
                "cifar100": dict( n_components=32),
            },
            "fit_kwargs": {
                "cifar10": dict(feature_layers_id=[-2]),
                "cifar100": dict(feature_layers_id=[-2]),
        ...
        "CRAFT_NMF_16_10_0.4": {
            "class": CRAFT_CONCEPTS,
            "kwargs": {
                "cifar10": dict( n_components=16, n_important_concepts=10, percentage_images_concept=0.4, n_designs=8 , model=load_pretrained_weights_32()),
                "cifar100": dict( n_components=16, n_designs=8, model=load_pretrained_weights_32()),
            },
            "fit_kwargs": {
                "cifar10": dict(feature_layers_id=[-2]),
                "cifar100": dict(feature_layers_id=[-2]),
        ...
        "CRAFT_NMF_16_10_0.5": {
            "class": CRAFT_CONCEPTS,
            "kwargs": {
                "cifar10": dict( n_components=16, n_important_concepts=10, percentage_images_concept=0.5, n_designs=16 , model=load_pretrained_weights_32()),
                "cifar100": dict( n_components=16, n_designs=16, model=load_pretrained_weights_32()),
            },
            "fit_kwargs": {
                "cifar10": dict(feature_layers_id=[-2]),
                "cifar100": dict(feature_layers_id=[-2]),
        ...
        "CRAFT_NMF_16_10_0.6": {
            "class": CRAFT_CONCEPTS,
            "kwargs": {
                "cifar10": dict( n_components=16, n_important_concepts=10, percentage_images_concept=0.6, n_designs=32 , model=load_pretrained_weights_32()),
                "cifar100": dict( n_components=16, n_designs=32, model=load_pretrained_weights_32()),
            },
            "fit_kwargs": {
                "cifar10": dict(feature_layers_id=[-2]),
                "cifar100": dict(feature_layers_id=[-2]),
        ...
        "CRAFT_NMF_16_10_0.7": {
            "class": CRAFT_CONCEPTS,
            "kwargs": {
                "cifar10": dict( n_components=16, n_important_concepts=10, percentage_images_concept=0.7, n_designs=32 , model=load_pretrained_weights_32()),
                "cifar100": dict( n_components=16, n_designs=32, model=load_pretrained_weights_32()),
            },
            "fit_kwargs": {
                "cifar10": dict(feature_layers_id=[-2]),
        ...
        "CRAFT_NMF_16_10_0.8": {
            "class": CRAFT_CONCEPTS,
            "kwargs": {
                "cifar10": dict( n_components=16, n_important_concepts=10, percentage_images_concept=0.8, n_designs=32 , model=load_pretrained_weights_32()),
                "cifar100": dict( n_components=16, n_designs=32, model=load_pretrained_weights_32()),
            },
            "fit_kwargs": {
                "cifar10": dict(feature_layers_id=[-2]),
        ...
        "CRAFT_NMF_16_10_0.9": {
            "class": CRAFT_CONCEPTS,
            "kwargs": {
                "cifar10": dict( n_components=16, n_important_concepts=10, percentage_images_concept=0.9, n_designs=32 , model=load_pretrained_weights_32()),
                "cifar100": dict( n_components=16, n_designs=32, model=load_pretrained_weights_32()),
            },
            "fit_kwargs": {
                "cifar10": dict(feature_layers_id=[-2]),
...
if __name__ == "__main__":
    dir_path = os.path.expanduser("~/") + "./results/cifar10_craft_tuning_percentage_images"
    os.makedirs(dir_path, exist_ok=True)
