...
class BenchmarkTorch:
    ...
    DETECTORS_CONFIG = {
        ...
        "NMF_CONCEPTS_200": {
            "class": NMF_CONCEPTS,
            "kwargs": {
                "cifar100": dict( n_components=200),
            },
            "fit_kwargs": {
                "cifar100": dict(feature_layers_id=[-2]),
            },
        ...
        "NMF_CONCEPTS_300": {
            "class": NMF_CONCEPTS,
            "kwargs": {
                "cifar100": dict( n_components=300),
            },
            "fit_kwargs": {
                "cifar100": dict(feature_layers_id=[-2]),
            },
        ...
        "NMF_CONCEPTS_400": {
            "class": NMF_CONCEPTS,
            "kwargs": {
                "cifar100": dict( n_components=400),
            },
            "fit_kwargs": {
                "cifar100": dict(feature_layers_id=[-2]),
            },
...
if __name__ == "__main__":
    dir_path = os.path.expanduser("~/") + "./results/number_concepts_tuning_multiplicateurs_nmf_cifar_100"
    os.makedirs(dir_path, exist_ok=True)
