...
class BenchmarkTorch:
    ...
    DETECTORS_CONFIG = {
        ...
        "PCA_KNN_5": {
            "class": PCA_KNN,
            "kwargs": {
                "cifar10": dict( n_components=5),
                "cifar100":dict( n_components=5),
            },
            "fit_kwargs": {
        ...
        "PCA_KNN_20": {
            "class": PCA_KNN,
            "kwargs": {
                "cifar10": dict( n_components=20),
                "cifar100":dict( n_components=20),
            },
            "fit_kwargs": {
                "cifar10": dict(feature_layers_id=[-2]),
                "cifar100": dict(feature_layers_id=[-2]),
        ...
        "PCA_KNN_30": {
            "class": PCA_KNN,
            "kwargs": {
                "cifar10": dict( n_components=30),
                "cifar100":dict( n_components=30),
            },
            "fit_kwargs": {
                "cifar10": dict(feature_layers_id=[-2]),
                "cifar100": dict(feature_layers_id=[-2]),
        ...
        "PCA_KNN_40": {
            "class": PCA_KNN,
            "kwargs": {
                "cifar10": dict( n_components=40),
                "cifar100":dict( n_components=40),
            },
            "fit_kwargs": {
                "cifar10": dict(feature_layers_id=[-2]),
                "cifar100": dict(feature_layers_id=[-2]),
        ...
        "PCA_KNN_50": {
            "class": PCA_KNN,
            "kwargs": {
                "cifar10": dict( n_components=50),
                "cifar100":dict( n_components=50),
            },
            "fit_kwargs": {
                "cifar10": dict(feature_layers_id=[-2]),
                "cifar100": dict(feature_layers_id=[-2]),
        ...
        "PCA_KNN_60": {
            "class": PCA_KNN,
            "kwargs": {
                "cifar10": dict( n_components=60),
                "cifar100":dict( n_components=60),
            },
            "fit_kwargs": {
                "cifar10": dict(feature_layers_id=[-2]),
                "cifar100": dict(feature_layers_id=[-2]),
        ...
        "PCA_KNN_70": {
            "class": PCA_KNN,
            "kwargs": {
                "cifar10": dict( n_components=70),
                "cifar100":dict( n_components=70),
            },
            "fit_kwargs": {
                "cifar10": dict(feature_layers_id=[-2]),
                "cifar100": dict(feature_layers_id=[-2]),
        ...
        "PCA_KNN_80": {
            "class": PCA_KNN,
            "kwargs": {
                "cifar10": dict( n_components=80),
                "cifar100":dict( n_components=80),
            },
            "fit_kwargs": {
                "cifar10": dict(feature_layers_id=[-2]),
                "cifar100": dict(feature_layers_id=[-2]),
        ...
        "PCA_KNN_90": {
            "class": PCA_KNN,
            "kwargs": {
                "cifar10": dict( n_components=90),
                "cifar100":dict( n_components=90),
            },
            "fit_kwargs": {
                "cifar10": dict(feature_layers_id=[-2]),
                "cifar100": dict(feature_layers_id=[-2]),
        ...
        "PCA_KNN_100": {
            "class": PCA_KNN,
            "kwargs": {
                "cifar10": dict( n_components=100),
                "cifar100":dict( n_components=100),
            },
            "fit_kwargs": {
                "cifar10": dict(feature_layers_id=[-2]),
                "cifar100": dict(feature_layers_id=[-2]),
...
if __name__ == "__main__":
    dir_path = os.path.expanduser("~/") + "./results/number_concepts_tuning_multiplicateurs_PCA_KNN_cifar_10"
    os.makedirs(dir_path, exist_ok=True)
